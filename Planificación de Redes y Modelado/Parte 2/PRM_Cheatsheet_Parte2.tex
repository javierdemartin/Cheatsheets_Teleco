...
$\rho$: Factor de utilización (intensidad de tráfico)\\
...
Envía cada trama y espera recibir un ACK o NACK:
	...
	\begin{itemize}
		\item Si lelga un ACK se libera el buffer que almacenaba el paquete transmitido y se envía otra trama.
...
Throughput máximo:
	...
	\begin{IEEEeqnarray*}{rCl}
		\gamma_{max}  = \lambda_{max} & = & \frac{1}{t_{v}} = \frac{1 - p}{t_{T}}	\\
								   & = & \frac{1 - p}{a \cdot t_{I}} (paq / seg)
	\end{IEEEeqnarray*}
