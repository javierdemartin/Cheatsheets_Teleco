...
Base Común                              & Emisor Común & Colector Común \\ \hline
    $\displaystyle h_{ib} = \frac{v_{eb}}{i_e} = \frac{h_{ie}}{1 + h_{fe}}$       &  $\displaystyle h_{ie} = \frac{v_{be}}{i_b} = \frac{V_{T} \beta}{I_{C}}$            &   $\displaystyle h_{ic} = \frac{v_{bc}}{i_b}$             \\ \hline
    $\displaystyle h_{rb} = \frac{v_{eb}}{v_{cb}}$   &   $\displaystyle h_{re} = \frac{v_{be}}{v_{ce}}$           &   $\displaystyle h_{rc} = \frac{v_{bc}}{v_{ec}}$             \\ \hline
    $\displaystyle h_{fb} = \frac{i_c}{i_e} = -\frac{-h_{fe}}{1 + h_{fe}}$       &  $\displaystyle h_{fe} = \frac{i_{c}}{i_{b}} = \beta$            &    $\displaystyle h_{fc} = \frac{i_{e}}{i_{b}}$            \\ \hline
...
\begin{equation*}
	I_{D} = I_{D_{SS}} \left( 1 - \frac{V_{gs}}{V_{gs_{off}}} \right)
\end{equation*}
