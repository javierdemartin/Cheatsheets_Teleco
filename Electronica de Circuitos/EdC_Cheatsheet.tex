...
\begin{enumerate}
	...
	\item \text{Identificar el tipo de alimentación}:
		\begin{enumerate}
			\item Entrada:
				\begin{enumerate}
					\item Serie: El camino de realimentación no está directamente unido al a entrada de la etapa.
					\item Paralelo: EL camino de realimentación está unido a la entrada de la etapa.
				\end{enumerate}
			\item Salida:
				\begin{enumerate}
					\item Serie: El camino de realimentación no está directamente unido a la salida de la etapa.
					\item Paralelo: La red de realimentación está directamente unida a la salida de la etapa.
				\end{enumerate}
		\end{enumerate}
	...
	\item \textbf{Ganancia en tensión}: Cuando hay más de una red de realimentación
	\item \textbf{TERMINAR}
\end{enumerate}
		...
		\begin{circuitikz}[scale=.4, transform shape]
			...
			\draw (5,0.25) to[R, l = $R_{L}$] (5,2.25)
			 ...
			 \draw (1.25, -1.75) node[plain amp, xscale = -1] (opamp) {$B$}
				  ...
				  (2.5,-.75) -| (3,2.25)
				  (2.5,-2.75) -| (4,.25);
			\draw (2,-3.5) node {Paralelo-Paralelo};
			...
			\draw (5,0.25) to[R, l = $R_{L}$] (5,2.25)
			 ...
			 \draw (1.25, -1.75) node[plain amp, xscale = -1] (opamp) {$B$}
				  ...
				  (0,-.75) -| (-.5,2.25)
				  (0,-2.75) -| (-1.5,.25);
			\draw (2,-3.5) node {Paralelo-Serie};
			\end{scope}
			...
			\draw (5,0.25) to[R, l = $R_{L}$] (5,2.25)
			 ...
			 \draw (1.25, -1.75) node[plain amp, xscale = -1] (opamp) {$B$}
				  ...
				  (2.5,-2.75) -| (4,.25)
				  (2.5,-.75) -| (3,2.25);
			\draw (2,-3.5) node {Serie-Paralelo};
			\end{scope}
